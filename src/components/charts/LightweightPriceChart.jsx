...
const LightweightPriceChart = ({ tokenPrice = 0, ethPrice = 0, tokenPriceDatas = [], chartType: initialChartType = 'candlestick', showControls = false, onClick, isMobile = false, defaultExpanded = false, chain = 'evm' }) => {
