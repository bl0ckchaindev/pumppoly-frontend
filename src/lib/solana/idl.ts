  ...
  "instructions": [
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "creator_vault_quote_account",
          "writable": true
        },
        {
          "name": "quote_mint"
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "bonding_curve_token_0_vault",
          "writable": true
        },
        {
          "name": "bonding_curve_token_1_vault",
          "writable": true
        },
        {
          "name": "base_mint",
    ...
    },
    {
      ...
      "accounts": [
        ...
        {
          "name": "seller_base_account",
          "writable": true
        },
        {
          "name": "seller_quote_account",
          "writable": true,
          "pda": {
            "seeds": [
              {
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "creator_migrate_fee_bps",
            "type": "u32"
          },
          {
            "name": "protocol_migrate_fee_bps",
            "type": "u32"
          },
          {
            "name": "migrator",
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {
            "name": "virtual_base_before",
            "type": "u64"
          },
          {
            "name": "virtual_quote_before",
            "type": "u64"
          },
          {
            "name": "platform_fee",
